...
describe("PLAYER METHODS", function () {
  describe("validateLocation", function () {
    let validateLocation =
      require("../game_logic/player_methods.js").validateLocation;
    let player;
  ...
  describe("validateLocations", function () {
    let validateLocations =
      require("../game_logic/player_methods.js").validateLocations;
    let player;
  ...
  describe("placeShip", function () {
    ...
    it("Should throw an error if no direction is specified", function () {
      let ship = player.ships[0];
      let coordinates = [0, 1];
      let handler = function (player, ship, coordinates) {
        placeShip();
      };
